...
public class BookController {
    ...
    @Operation(summary = "Creates a Book, Author and Gen in the same process")
    @PutMapping(value = "/{isbn}/full")
    @ResponseStatus(HttpStatus.CREATED)
    public ResponseEntity<BookView> createFullProcess(@ModelAttribute CreateFullProcessRequest resource, @PathVariable("isbn") final String isbn) {
