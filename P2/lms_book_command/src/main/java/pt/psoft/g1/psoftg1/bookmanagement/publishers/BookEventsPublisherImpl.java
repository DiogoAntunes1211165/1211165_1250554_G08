...
public class BookEventsPublisherImpl implements BookEventsPublisher {
    ...
    public void sendBookLendingResponse(SagaCreationResponse response) {
        ...
        try {
            ...
            this.rabbitTemplate.convertAndSend(directExchange.getName(), "book.lending.response", responseInString);

        } catch (JsonProcessingException e) {
            System.out.println("Error sending book lending response to AMQP: " + e.getMessage());
        }
