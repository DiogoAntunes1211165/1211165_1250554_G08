...
public class LendingEntity {
     ...
     * business specified number of days a reader can take to return the book ({@link pt.psoft.g1.psoftg1.lendingmanagement.model.Lending#MAX_DAYS_PER_LENDING}).
     *
     ...
     * */
    public LendingEntity(BookEntity book, ReaderDetailsEntity readerDetails, int seq, int lendingDuration, int fineValuePerDayInCents){
        try {
        ...
        this.lendingNumber = new LendingNumberEntity(seq);
